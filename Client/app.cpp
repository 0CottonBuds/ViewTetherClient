...
App::~App(){
    streamDecoderThread.quit();
    streamDecoderThread.wait();
}
...
void App::initializeButtons(){
    ...
    connect(clientWidget->backButton1, &QPushButton::clicked, this, [this]{clientWidget->appRouter->setCurrentWidget(clientWidget->welcomePage);});
}
