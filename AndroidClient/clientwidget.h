/********************************************************************************
** Form generated from reading UI file 'clientwidgetBVxkNC.ui'
**
...
#ifndef CLIENTWIDGETBVXKNC_H
#define CLIENTWIDGETBVXKNC_H
...
public:
    ...
    void setupUi(QMainWindow *ClientWidget)
    {
        ...
        label_7->setGeometry(QRect(16, 88, 425, 73));
        ...
        label_3->setGeometry(QRect(50, 120, 361, 101));
        QFont font1;
        ...
        frame_3->setGeometry(QRect(150, 320, 161, 121));
    ...
    void retranslateUi(QMainWindow *ClientWidget)
    {
        ...
        label_7->setText(QCoreApplication::translate("ClientWidget", "Second-Screen-Client is an Desktop and Android application designed to nreceive and display pixel data streamed from the Screen-Capture desktop \n"
"application. This allows your other device to function as a secondary screen for \n"
"your Windows machine. Make sure to have the Screen-Capture desktop \n"
"application installed and running on your Windows computer.", nullptr));
        ...
        label_3->setText(QCoreApplication::translate("ClientWidget", "Welcome to \n"
"Second Screen Client", nullptr));
        ...
        label_5->setText(QCoreApplication::translate("ClientWidget", "Connect using the address in your second screen server", nullptr));
